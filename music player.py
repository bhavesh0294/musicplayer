...
class Player(tk.Frame):
    ...
    def create_frames(self):
        self.track = tk.LabelFrame(self, text='MUSIC PLAYER',
    ...
    def track_widgets(self):
        ...
        self.songtrack['text'] = 'GITS MUSIC PLAYER'
        self.songtrack.config(width=30, height=1)
        self.songtrack.grid(row=1, column=0, padx=10)

    def control_widgets(self):
        self.loadSongs = tk.Button(self.controls, bg='green', fg='white', font=20)
        ...
        self.slider = tk.Scale(self.controls, from_=0, to=100, orient=tk.VERTICAL)
    ...
    def retrieve_songs(self):
        ...
        self.tracklist['text'] = f'SONGS - {str(len(self.SONGS))}'
...
root.wm_title('ALL IN PLAYER')

img = ImageTk.PhotoImage(file='images/music1.gif')
